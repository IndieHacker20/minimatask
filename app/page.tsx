        ...
        <nav aria-label="Global" className="flex items-center justify-between p-6 lg:px-8">
          <div className="flex lg:flex-1">
            <Link href="/" className="-m-1.5 p-1.5">
              <span className="sr-only">Minimatask</span>
              <img
                alt=""
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
            <h1 className="text-5xl font-medium tracking-tight text-balance text-black sm:text-7xl">
              <span className="font-bold text-rose-600">Meaningfully</span> Plan Your Day
            </h1>
            <p className="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">
              The only app busy investors and entrepreneurs need to make each day more meaningful.
            </p>
